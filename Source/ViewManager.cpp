...
void ViewManager::ProcessKeyboardEvents()
{
	...
	{
		g_pCamera->Position += g_pCamera->Up * gDeltaTime * 5.0f;
	}
	...
	// Toggle Lighting
	if (glfwGetKey(m_pWindow, GLFW_KEY_L) == GLFW_PRESS && !lPressed)
	{
		if (m_pSceneManager != nullptr)
			m_pSceneManager->ToggleLighting();
		lPressed = true;
	}
	if (glfwGetKey(m_pWindow, GLFW_KEY_L) == GLFW_RELEASE)
	{
		lPressed = false;
	}
}
...
void ViewManager::SetSceneManager(SceneManager* sceneManager)
{
